package com.pnc.excel.handler;

import com.pnc.core.exception.OperationFailtureException;
import com.pnc.excel.domain.HandleResult;
...
public class ExcelImportHandler {
    ...
    private static String[] getCvsRowData(String line) {
        try {
            ...
            log.error(error, e);
            throw new OperationFailtureException(error + " " + e.getMessage());
        }
    }
     ...
     */
    public HandleResult doConfirmSource(Object dataSource) {
        HandleResult result = new HandleResult(false, null);
        try {
