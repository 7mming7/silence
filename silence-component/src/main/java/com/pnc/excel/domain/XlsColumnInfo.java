package com.pnc.excel.domain;

import com.pnc.core.Enum.DataType;
...
public class XlsColumnInfo {
     ...
     * 默认构造函数
     */
    public XlsColumnInfo(String columnName, int columnIndex, DataType dataType, boolean required) {
     ...
     * 默认构造函数
     */
    public XlsColumnInfo(String columnName, int columnIndex, DataType dataType, boolean required, String expression) {
        this.columnName = columnName;
        this.columnIndex = columnIndex;
        this.dataType = dataType;
        this.required = required;
