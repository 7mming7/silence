...
public class MesuringPointService {
    ...
    public static Map<Item, ItemState> fetchReadSyncItems (final int cid) {
        ...
        boolean flag = true;
<<<<<<< HEAD:silence-component/src/main/java/com/pnc/opc/service/MesuringPointService.java
        if (!opcServerInfomation.isConnect() || opcServerInfomation.getLeafs() == null) {
=======
        if ( !opcServerInfomation.isConnect() ||opcServerInfomation.getLeafs() == null) {
>>>>>>> origin/master:silence-component/src/main/java/com/sq/opc/service/MesuringPointService.java
            flag = false;
